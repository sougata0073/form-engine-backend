...
import com.sougata.form_service.dto.validationConfig.ShortAnswerValidationConfig;
import com.sougata.form_service.exception.ResponseValidationException;
import com.sougata.form_service.util.StringUtil;
...
public class ShortAnswerValidator {
    ...
    public static class LengthMaxCharacterCount implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.MaxCharacterCount> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.MaxCharacterCount validationConfig) {
        ...
        @Override
        public Class<ShortAnswerValidationRequestDto> getValidationRequestClass() {
    ...
    public static class LengthMinCharacterCount implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.MinCharacterCount> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.MinCharacterCount validationConfig) {
            if (validationRequestDto.getText().length() < validationConfig.getNumber()) {
                throw new ResponseValidationException(
                        String.format(
    ...
    public static class NumberIsNumber implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.IsNumber> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.IsNumber validationConfig) {
    ...
    public static class NumberGreaterThan implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.GreaterThan> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.GreaterThan validationConfig) {
    ...
    public static class NumberGreaterThanOrEqualTo implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.GreaterThanOrEqualTo> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.GreaterThanOrEqualTo validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
            if (parsed == null || !(parsed >= validationConfig.getNumber())) {
                throw new ResponseValidationException(
    ...
    public static class NumberLessThan implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.LessThan> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.LessThan validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
            if (parsed == null || !(parsed < validationConfig.getNumber())) {
                throw new ResponseValidationException(
    ...
    public static class NumberLessThanOrEqualTo implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.LessThanOrEqualTo> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.LessThanOrEqualTo validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
            if (parsed == null || !(parsed <= validationConfig.getNumber())) {
                throw new ResponseValidationException(
    ...
    public static class NumberEqualTo implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.EqualTo> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.EqualTo validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
    ...
    public static class NumberNotEqualTo implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.NotEqualTo> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.NotEqualTo validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
            if (parsed == null || parsed.equals(validationConfig.getNumber())) {
                throw new ResponseValidationException(
    ...
    public static class NumberBetween implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.Between> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.Between validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
    ...
    public static class NumberNotBetween implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.NotBetween> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.NotBetween validationConfig) {
            Double parsed = parseNumber(validationRequestDto.getText());
            if (parsed == null || (parsed >= validationConfig.getFromNumber() && parsed <= validationConfig.getToNumber())) {
                throw new ResponseValidationException(
    ...
    public static class NumberWholeNumber implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.WholeNumber> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.WholeNumber validationConfig) {
            try {
    ...
    public static class RegexMatches implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.Matches> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.Matches validationConfig) {
    ...
    public static class RegexDoesNotMatch implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.DoesNotMatch> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.DoesNotMatch validationConfig) {
            String pattern = validationConfig.getText();
            if (pattern == null) {
                pattern = "";
            }
    ...
    public static class TextContains implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.Contains> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.Contains validationConfig) {
    ...
    public static class TextDoesNotContains implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.DoesNotContains> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.DoesNotContains validationConfig) {
            if (validationRequestDto.getText() == null || validationConfig.getText() == null) {
                return true;
            }
            if (validationRequestDto.getText().contains(validationConfig.getText())) {
    ...
    public static class TextEmail implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.Email> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.Email validationConfig) {
    ...
    public static class TextUrl implements
            ResponseValidator<ShortAnswerValidationRequestDto, ShortAnswerValidationConfig.Url> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, ShortAnswerValidationConfig.Url validationConfig) {
    ...
    public static class None implements ResponseValidator<ShortAnswerValidationRequestDto, NoneValidationConfig> {

        @Override
        public boolean isValid(ShortAnswerValidationRequestDto validationRequestDto, NoneValidationConfig validationConfig) {
            return true;
        }
